...
class Scoreboard:
    ...
    def points(self, value: int):
        if isinstance(value, int) and value >= 0:
            ...
            raise ValueError("La puntuación debe ser un entero positivo.")
    ...
    @text_color.setter
    def text_color(self, value: tuple):
        if isinstance(value, tuple) and len(value) == 3 and all(0 <= c <= 255 for c in value):
            self._text_color = value
        else:
            raise ValueError("El color debe ser una tupla de tres valores RGB entre 0 y 255.")
    ...
    def font(self, value: str):
        if isinstance(value, str) and value.strip():
            ...
            raise ValueError("La fuente debe ser una cadena de texto no vacía.")
...
if __name__ == "__main__":
    ...
    print("\nSe crea un objeto con valores predeterminados:")
    marcador1 = Scoreboard()
    print(f"marcador1 = {marcador1}")

    print("\nSe crea otro objeto con valores personalizados:")
    marcador2 = Scoreboard(10, text_color=(127, 127, 127), font="Times New Roman", size=18)
    print(f"marcador2 = {marcador2}")

    print("\nSe prueba el método draw() en ambos objetos:")
    marcador1.draw()
    marcador2.draw()
