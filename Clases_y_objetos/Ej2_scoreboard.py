...
class Scoreboard:
    ...
    def draw(self) -> None:
        """
        Esta función muestra los puntos en pantalla
        :return: No retorna nada.
        """
        print(f"Scoreboard =  Puntos: {self._points}")



    # Métodos property y getter/setter
    #Son los métodos que permiten acceder y modificar los atributos de una clase, mediante el encapsulamiento, manteniendo la protección de los datos
    @property
    def points(self) -> int:
        return self._points
    @points.setter
